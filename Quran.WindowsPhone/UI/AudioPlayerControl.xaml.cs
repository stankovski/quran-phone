...
namespace Quran.WindowsPhone.UI
{
    public partial class AudioPlayerControl
    {
        ...
        {
            InitializeComponent();
            this.PlayButtonGrid.Visibility = Windows.UI.Xaml.Visibility.Visible;
            this.PauseButtonGrid.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
            this.NextButtonGrid.Visibility = Windows.UI.Xaml.Visibility.Visible;
            this.PreviousButtonGrid.Visibility = Windows.UI.Xaml.Visibility.Visible;
            //this.StopButtonGrid.Visibility = Windows.UI.Xaml.Visibility.Visible;
            this.RepeatButtonGrid.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
            this.NoRepeatButtonGrid.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
            this.SettingsButtonGrid.Visibility = Windows.UI.Xaml.Visibility.Visible;
        ...
        public static readonly DependencyProperty RepeatEnabledProperty = DependencyProperty.Register("RepeatEnabled",
            ...
            new PropertyMetadata(null, ChangeRepeatEnabled));
        ...
        private void ButtonTap(object sender, TappedRoutedEventArgs e)
        {
