...
namespace Quran.Core.Utils
{
    public static class FileUtils
    {
        ...
        static FileUtils()
        {
            ...
            MakeQuranDirectory().ConfigureAwait(true).GetAwaiter().GetResult();
            MakeQuranDatabaseDirectory().ConfigureAwait(true).GetAwaiter().GetResult();

            // Delete stuck files
            DeleteStuckFiles().ConfigureAwait(true).GetAwaiter().GetResult();
        }
