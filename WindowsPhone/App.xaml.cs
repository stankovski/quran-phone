...
namespace QuranPhone
{
    public partial class App : Application
    {
        ...
        private static DetailsViewModel detailsViewModel;
        private static TranslationsListViewModel translationsListViewModel;
        ...
        private void InitializeLanguage()
        {
            try
            {
                ...
                // the resource file.
                var flow = (FlowDirection) Enum.Parse(typeof (FlowDirection), AppResources.ResourceFlowDirection, true);
