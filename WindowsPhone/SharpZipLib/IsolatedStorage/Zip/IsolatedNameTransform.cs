...
{
	/// <summary>
	/// IsolatedNameTransform transforms <see cref="ZipFile"/> names to windows compatible ones.
	/// </summary>
	public class IsolatedNameTransform : INameTransform
	{
		/// <summary>
		/// Initialises a new instance of <see cref="IsolatedNameTransform"/>
		/// </summary>
		/// <param name="baseDirectory"></param>
		public IsolatedNameTransform (string baseDirectory)
		{
		...
		/// <summary>
		/// Initialise a default instance of <see cref="IsolatedNameTransform"/>
		/// </summary>
		public IsolatedNameTransform ()
		{
			// Do nothing.
		}
