...
namespace Quran.Windows.UI
{
    public partial class AudioPlayerControl
    {
        ...
        {
            InitializeComponent();
            this.PlayButtonGrid.Visibility = Visibility.Visible;
            this.PauseButtonGrid.Visibility = Visibility.Collapsed;
            this.NextButtonGrid.Visibility = Visibility.Visible;
            this.PreviousButtonGrid.Visibility = Visibility.Visible;
            //this.StopButtonGrid.Visibility = Visibility.Visible;
            this.RepeatButtonGrid.Visibility = Visibility.Collapsed;
            this.NoRepeatButtonGrid.Visibility = Visibility.Collapsed;
            this.SettingsButtonGrid.Visibility = Visibility.Visible;
